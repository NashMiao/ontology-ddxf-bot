...
from dbot.crypto.digest import (
    sha256,
    hash160,
    hash256
)
...
class TestDigest(unittest.TestCase):
    def test_sha256(self):
        ...
        self.assertEqual(sha256_digest, sha256(msg))
        self.assertEqual(hex_sha256_digest, sha256(msg, is_hex=True))
    ...
    def test_hash256(self):
        ...
        self.assertEqual(hash256_digest, hash256(msg))
        self.assertEqual(hex_hash256_digest, hash256(msg, is_hex=True))
    ...
    def test_hash160(self):
        ...
        self.assertEqual(hash160_digest, hash160(msg))
        self.assertEqual(hex_hash160_digest, hash160(msg, is_hex=True))
